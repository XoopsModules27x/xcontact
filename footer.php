...
$GLOBALS['xoopsTpl']->assign('admin', \XCONTACT_ADMIN);
$GLOBALS['xoopsTpl']->assign('copyright', $copyright);
// Meta description
xcontactMetaDescription((string)$helper->getConfig('metadescription'));

// Paths
$GLOBALS['xoopsTpl']->assign('xoops_mpageurl', \XCONTACT_URL.'/index.php');
