...
\define('_AM_XCONTACT_SET_SLUG_HINT',        'Küçük harfler ve tire işaretleri kullanılabilir; örneğin: iletisim-formu. Slug benzersiz olmalıdır!');
\define('_AM_XCONTACT_SET_DESC',             'Açıklama');
\define('_AM_XCONTACT_SET_DESC_HINT',        'Açıklama, formun üst kısmında görüntülenecektir');
...
\define('_AM_XCONTACT_FORMS_COL_TEMPLATE', 'Şablon');
