...
\define('_MI_XCONTACT_CAPTCHA_GOOGLE', 'GOOGLE Captcha tuşu');
\define('_MI_XCONTACT_CAPTCHA_GOOGLE_DESC', 'GOOGLE reCaptcha anahtarını girin - sadece Google reCAPTCHA için geçerlidir');
