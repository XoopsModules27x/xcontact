...
\define('_AM_XCONTACT_SET_SLUG_HINT',        'Lowercase letters and hyphens are allowed, e.g. contact-form. The slug must be unique!');
\define('_AM_XCONTACT_SET_DESC',             'Description');
\define('_AM_XCONTACT_SET_DESC_HINT',        'The description will be shown on the top of the form');
...
\define('_AM_XCONTACT_FORMS_COL_TEMPLATE', 'Template');
