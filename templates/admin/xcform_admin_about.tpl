<div class="xcp-wrap">
    <h2>ℹ️ <{$xcf_about_title}></h2>
    <table class="xcp-table" style="max-width:500px">
        <tr><th><{$xcf_about_mod_name}></th><td>xcform</td></tr>
    ...
    <h3 style="margin-top:24px"><{$xcf_about_features}></h3>
    <ul>
        <li><{$xcf_about_f1}></li>
        <li><{$xcf_about_f2}></li>
        <li><{$xcf_about_f3}></li>
    ...
    <h3><{$xcf_about_usage}></h3>
    <p><{$xcf_about_link_usage}> <code><{$xoops_url}>/modules/xcform/form.php?slug=SLUG</code></p>
    <p><{$xcf_about_block_use}></p>
</div>
