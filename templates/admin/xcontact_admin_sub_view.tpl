<div class="xcp-wrap">
    <div class="xcp-header">
        <h2>📧 <{$smarty.const._AM_XCONTACT_SUB_VIEW_TITLE}> #<{$sub.sub_id|escape}> — <{$form.name|escape}></h2>
        <a href="<{$module_url}>admin/submissions.php?form_id=<{$sub.form_id|escape:'url'}>" class="xcp-btn xcp-btn--gray"><{$smarty.const._AM_XCONTACT_SUB_VIEW_BACK}></a>
    </div>
