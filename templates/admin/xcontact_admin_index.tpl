        ...
        <div class="xcp-widget">
            ...
            <table class="xcp-table">
                ...
                <tr>
                    ...
                    <td><a href="<{$module_url}>admin/form_edit.php?id=<{$f.form_id}>" class="xcp-btn xcp-btn--blue"><{$smarty.const._AM_XCONTACT_FORMS_BTN_EDIT}></a></td>
                </tr>
                <{/foreach}>
            </table>
            <{else}><p class="xcp-empty"><{$smarty.const._AM_XCONTACT_DASH_NO_FORMS}> <a href="<{$module_url}>admin/form_edit.php"><{$smarty.const._AM_XCONTACT_DASH_NEW_FORM}></a></p><{/if}>
        </div>
        <div class="xcp-widget">
