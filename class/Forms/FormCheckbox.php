 ...
 */
class FormCheckbox extends \XoopsFormSelect
{
    ...
    /**
     * create HTML to output the checkbox field
     *
     * @return string
     */
    public function render()
    {
        ...
        foreach ($elementOptions as $value => $name) {
            $ret .= '<label><input type="' . $this->getType() . '" name="' . $this->getName() . $arrSuffix . '" title="'
    ...
    /**
     * Set as array type value
     *
     * @param bool $value
     */
    public function setAsArray($value) {
