<div class="xcp-wrap">
    <div class="xcp-header">
        <h2>📧 <{$xcf_sub_view_title}> #<{$sub.sub_id}> — <{$form.name}></h2>
        <a href="<{$module_url}>admin/submissions.php?form_id=<{$sub.form_id}>" class="xcp-btn xcp-btn--gray"><{$xcf_sub_view_back}></a>
    </div>
    <p style="color:#888;font-size:12px"><{$xcf_subs_col_date}>: <{$sub.created_at|date_format:"%d.%m.%Y %H:%M"}> · IP: <{$sub.ip}></p>
